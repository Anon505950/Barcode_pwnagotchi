...
for pcap in pcap_files:
    ...
    for bssid in bssids:
        ...
        # Rename GeoWiFi output to BSSID-based filename
        correct_name = os.path.join(RESULTS_DIR, bssid.replace(":", "_") + ".html")
        os.rename(html_file, correct_name)

        html_file = correct_name
        if not html_file:
